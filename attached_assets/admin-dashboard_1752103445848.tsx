...
import { Users, BookOpen, Settings, Activity, Plus, Edit, Trash2, GraduationCap, RefreshCw } from "lucide-react";
...
export default function AdminDashboard({ user, onLogout }: AdminDashboardProps) {
  ...
  const deleteLevelMutation = useMutation({
    ...
    onSuccess: async (data, levelId) => {
      ...
      // 5. Force page reload for local environments as fallback
                    ...
                    <TableBody>
                      {levels.map((level: any) => (
                        <TableRow key={level.id}>
                          ...
                          <TableCell>
                            <Badge variant={level.category === 'college' ? 'default' : 'secondary'}>
